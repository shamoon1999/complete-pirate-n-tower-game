...
var bg_sound, cannon_explosion, cannon_splash, piratelaugh;
...
function preload() {
  ...
  bg_sound = loadSound("assets/background_music.mp3");
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if (collision.collided && !boats[i].isBroken) {
        // for condition of not playing laugh sound more than once/continuously///
